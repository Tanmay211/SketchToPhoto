"""
******
MINIPROJECT ON SKETCH TO IMAGE CONVERTER BY ROLL NO:2012474,2012648,2012654,21021630 OF BTECH CS SECTION A 3rd SEMESTER
******
...
json_file.close()
list=[]
print("sketch to photo conversion miniproject by Roll number:5,24,40,59 section A Btech CS 3rd semester")
s=data['background']
